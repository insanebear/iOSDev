//
//  OnlyLocationNotificationViewController.swift
...
// TODO: Stop update user location when the app goes background
class OnlyLocationNotificationViewController: UIViewController {
    /// views
